...
###################### TELAS ################################################*/
  ...
  void dog() {
    ...
    byte dog10[8] = {B00000, B11100, B10010, B10010, B10010, B10001, B10001, B10001};
    byte dog26[8] = {B10001, B10001, B10001, B10001, B10001, B10010, B01010, B00100};
    byte dog09[8] = {B11111, B00000, B00000, B00000, B01110, B01110, B01110, B00000};
    byte dog08[8] = {B11111, B00000, B00000, B00000, B01110, B01110, B01110, B00000};
    byte dog07[8] = {B00000, B00111, B01001, B01001, B01001, B10001, B10001, B10001};
    byte dog23[8] = {B10001, B10001, B10001, B10001, B10001, B10010, B01010, B00100};
    byte dog24[8] = {B00000, B00111, B00111, B00011, B00001, B00000, B00000, B00000};
    byte dog25[8] = {B00000, B11100, B11100, B11000, B10000, B00000, B00000, B00000};

    lcd.createChar(0, dog10);
    lcd.createChar(1, dog26);
    lcd.createChar(2, dog09);
    lcd.createChar(3, dog08);
    lcd.createChar(4, dog07);
    lcd.createChar(5, dog23);
    lcd.createChar(6, dog24);
    lcd.createChar(7, dog25);
//9,0  9,1  8,0  7,0  6,0  6,1  7,1  8,1
    lcd.setCursor(11, 1);
    lcd.write(byte(0));
    lcd.setCursor(11, 2);
    lcd.write(byte(1));
