...
################### VARIABLES OR FIXED #######################################*/
  ...
  int8_t lastVolume = 15; //volume atual
...
############################ TELAS #################################################*/
  ...
  void Home_screen() {
    ...
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print(cu[3]); lcd.print("/"); lcd.print(cu[4]);lcd.print("/");lcd.print(cu[5]);
    // lcd.setCursor(17, 0);
    // lcd.print(rtc.dayOfWeek()-1);
    lcd.setCursor(1, 1);
    lcd.print(cu[0]);lcd.print(":");lcd.print(cu[1]);
    lcd.setCursor(11, 0);
    lcd.print("Next meal");
    lcd.setCursor(13, 1);
    lcd.print("16:30");
    ...
    lcd.setCursor(14, 3);
    lcd.print("10");lcd.write(byte(0));lcd.write(byte(1));
